...
public class PupColor {
    ...
    public static ColorPupModel PupColor(){
        ...
        int[] heads={R.color.custom1,R.color.custom2,R.color.custom3,R.color.custom5,R.color.colorAccent};
         int[] seconds={R.color.hollowcustom3,R.color.hollowcustom2,R.color.hollowcustom6,R.color.hollowcustom4,R.color.hollowcustom5};
